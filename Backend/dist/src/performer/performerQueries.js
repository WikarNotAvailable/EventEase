...
exports.getPerformersByType = "SELECT p.*, t.type FROM performers AS p JOIN performertypes AS t ON p.performertype_id = t.performertype_id WHERE t.performertype_id = $1";
