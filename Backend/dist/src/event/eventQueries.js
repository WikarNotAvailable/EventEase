...
exports.getEventByDiscussionId = exports.getEventsByPerformerId = exports.getEventsWithSoldOutTickets = exports.getEventsWithLimitedAvailability = exports.getEventsWithAvailableTickets = exports.getEventsWithinDateRange = exports.getEventsByEventTypeId = exports.getEventsBySpotId = exports.updateEvent = exports.deleteEvent = exports.getEventById = exports.getEvents = exports.addEvent = void 0;
exports.addEvent = "INSERT INTO events (name, description, BeginDate, EndDate, AvailableTickets, CurrentlyTakenTickets, spot_id, eventtype_id, company_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *";
...
exports.updateEvent = "UPDATE events SET name = $1, description = $2, begindate = $3, enddate = $4, availabletickets = $5, currentlytakentickets = $6, spot_id = $7, eventtype_id = $8, company_id = $9 WHERE event_id = $10 RETURNING *";
...
exports.getEventsByPerformerId = `
  ...
  WHERE
    ...
    LIMIT $2
`;
exports.getEventByDiscussionId = `
  SELECT
    e.*,
    et.name AS eventtype_name,
    json_build_object(
