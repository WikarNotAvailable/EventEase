...
export const checkPerformerTypeExists = "SELECT * from performertypes WHERE type = $1"
export const deletePerformerType = "Delete FROM performertypes WHERE performertype_nba = $1";
