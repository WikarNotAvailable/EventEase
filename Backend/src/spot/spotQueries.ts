...
export const getSpotByType = "SELECT spots.*, addresses.*, spottypes.name  FROM spots INNER JOIN addresses ON spots.address_id = addresses.address_id INNER JOIN spots.spottype_id = spottypes.spottype_id WHERE spottype_id = $1";
