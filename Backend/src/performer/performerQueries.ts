...
export const getPerformers = "SELECT * FROM performers AS p JOIN performertypes AS t ON p.performertype_id = t.performertype_id";
export const getPerformerById = "SELECT * FROM performers AS p JOIN performertypes AS t ON p.performertype_id = t.performertype_id WHERE performer_id = $1";
